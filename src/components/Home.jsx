...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden">
      <section className="homeBannerBg mb-20 flex flex-col items-center h-screen w-full relative">
        <div className="pt-[140px]">
          <div className="text-6xl font-bold text-center mb-5 boldText text-[#06362E]">
            Where Serenity Meets <span className="block">Luxury</span>
          </div>
          <div className="text-sm text-center max-w-[700px] mx-auto smallText">
            ...
            <div className='md:w-[70%]'>
              ...
              <div className='flex pr-2 scrollbar w-full gap-5 mb-7 overflow-auto whitespace-nowrap flex-shrink-0'>
                <div className='w-[300px] h-[200px] rounded-2xl bg-[#000] overflow-hidden flex-shrink-0'>
                  <img src="https://i.pinimg.com/originals/bd/61/c2/bd61c2a299e4b9a171d3a94f00f20b5e.jpg" alt="" className='w-full h-full object-cover'/>
                </div>
                <div className='w-[300px] h-[200px] rounded-2xl bg-[#000] overflow-hidden flex-shrink-0'>
                  <img src="https://i.pinimg.com/736x/3b/1c/ab/3b1cab97dd30791589a9938b6611779e.jpg" alt="" className='w-full h-full object-cover'/>
                </div>
                <div className='w-[300px] h-[200px] rounded-2xl bg-[#000] overflow-hidden flex-shrink-0'>
                  <img src="https://avatars.mds.yandex.net/i?id=8aa00eb9b234b1025af1cafe38905bc7_l-5291151-images-thumbs&ref=rim&n=13&w=1700&h=1135" alt="" className='w-full h-full object-cover'/>
                </div>
                <div className='w-[300px] h-[200px] rounded-2xl bg-[#000] overflow-hidden flex-shrink-0'>
                  <img src="https://avatars.mds.yandex.net/i?id=8aa00eb9b234b1025af1cafe38905bc7_l-5291151-images-thumbs&ref=rim&n=13&w=1700&h=1135" alt="" className='w-full h-full object-cover'/>
                </div>
              ...
              {/* Content */}
              <div className='boldText text-5xl font-bold'>Unlock the Art of <span className='block'>Sophisticated Stays</span></div>
            </div>
            {/* Right */}
            <div className='md:w-[30%]'>
              <div className='mb-10'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit hic repudiandae et quia vero laboriosam aliquam omnis perferendis nobis in quae eveniet, rem, voluptatibus enim eaque fugit distinctio. Dolorem, corrupti.</div>
              <div className='flex items-center gap-5 mb-10'>
                ...
                <div className='font-medium leading-tight'>100k + happy guests</div>
              </div>
              <div className='flex justify-between items-center'>
                <div className='flex justify-center items-center gap-1 py-2 px-4 rounded-full border border-[#00000022]'>4.9 <IoIosStar/></div>
                <button className='py-2 px-4 rounded-full border border-[#0002] font-semibold'>Book Your Room</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mb-10 py-10 w-full bg-gradient-to-b from-[#fff] via-[#ffe7aeaf] to-[#FFFFFF] relative">
        <div className="absolute top-0 bottom-0 left-0 right-0 opacity-">
          <img src={demo} alt="" className="h-full w-full object-cover" />
        </div>
        <div className="max-w-[1400px] bg-[#fff3d7] mx-auto py-16 rounded-3xl px-20 drop-shadow-sm">
          <div className="text-center mb-10 font-bold boldText text-5xl text-[#06362E]">
            Lorem Ipsum Lorem <span className="block">ipsum dolor sit</span>
          </div>
          {/* Rooms */}
          <div className="grid grid-cols-3 place-items-center gap-5 relative z-20">
            <div className="w-full h-[400px] rounded-3xl relative shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] px-2 py-2 overflow-hidden bg-[#06362E]">
              <div className="h-[70%] w-full rounded-3xl overflow-hidden">
                <img
                  src="https://media.cntraveler.com/photos/53dabff3dcd5888e145ca051/master/w_1200,c_limit/eccleston-square-hotel-london-england-2-113144.jpg"
                  alt=""
            ...
            <div className="w-full h-[400px] rounded-3xl relative shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] px-2 py-2 overflow-hidden bg-[#06362E]">
              <div className="h-[70%] w-full rounded-3xl overflow-hidden">
                <img
                  src="https://avatars.yandex.net/get-music-content/103235/e81336ad.a.7205355-1/m1000x1000?webp=false"
                  alt=""
                  className="w-full h-full object-cover"
                />
              </div>
            ...
            <div className="w-full h-[400px] rounded-3xl relative shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] px-2 py-2 overflow-hidden bg-[#06362E]">
              <div className="h-[70%] w-full rounded-3xl overflow-hidden">
                <img
                  src="https://roofhotels.com.tr/wp-content/uploads/2022/06/dnm-1.jpg"
                  alt=""
                  className="w-full h-full object-cover"
                />
              </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-6 gap-5 w-full'>
            ...
            <div className='col-span-4 w-full h-[450px] bg-[#000] overflow-hidden rounded-3xl relative'>
              <div className='absolute top-0 left-0 right-0 bottom-0'>
                <img src="https://avatars.mds.yandex.net/get-altay/2389272/2a000001764c9e2d4d76abfe0fc90fd6208f/XXL_height" alt="" className='w-full h-full object-cover'/>
              </div>
              ...
              <div className='absolute z-10 w-[250px] h-[150px] px-5 py-5 rounded-3xl bg-[#00000036] text-[#fff] right-2 top-2 backdrop-blur-sm'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis dolor dolores dolore tenetur eveniet
              </div>
              <div className='absolute bottom-10 left-10 text-5xl boldText text-[#fff] font-bold leading-tight'>Your Comfort <span className='block'>Outside Home</span></div>
            </div>
            {/* right */}
            <div className='flex flex-col gap-5 w-full col-span-2'>
              <div className='w-full h-[215px] rounded-3xl bg-[#000] relative overflow-hidden'>
                ...
                <div className='flex flex-col absolute bottom-2 px-10 z-10'>
                  <div className='boldText font-bold text-2xl relative z-10   text-[#fff]'>Home Stay</div>
                  <div className='text-sm text-[#fff]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat, quasi.</div>
                </div>
                <div className='absolute top-0 bottom-0 left-0 right-0'>
                  <img src="https://image.winudf.com/v2/image/Y29tLmFwbmFmYXNoaW9uLmJlZHJvb21kZXNpZ25fc2NyZWVuXzRfMTUzOTg1ODMwN18wMTE/screen-4.jpg?fakeurl=1&type=.jpg" alt="" className='w-full h-full object-cover'/>
                </div>
              </div>
              <div className='w-full h-[215px] rounded-3xl bg-[#000] relative overflow-hidden'>
                <div className='absolute top-0 bottom-0 left-0 right-0'>
                  <img src="https://i.pinimg.com/originals/92/42/6a/92426a43fd391f5ca2d73b4ac862b23a.jpg" alt="" className='w-full h-full object-cover'/>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="mb-20">
        <div className="max-w-[1400px] mx-auto">
          <div className="md:flex justify-center gap-10 w-full px-10">
            {/* Left */}
            <div className="md:w-[40%] h-full">
              <div className="text-8xl font-bold boldText mb-10 text-[#06362E]">
                Inspiring <span className="block">Locations</span>{" "}
                <span className="block">to Lodge</span>
              </div>
              <div className="mb-10 text-[#06362E]">
            ...
            <div className="col-span-4 flex flex-col gap-2">
              ...
              >
                ...
                <div className='relative py-10 px-10 '>
                  <div className='boldText text-5xl text-[#fff] font-bold mb-5'>Find Your <span className='block'>Perfect Space</span></div>
                  <div className='text-sm max-w-[400px] text-[#fff]'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptatem temporibus minus itaque! Amet autem accusantium pariatur labore cumque architecto ut.</div>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center gap-2">
                ...
                <div className='w-full h-[300px] relative p-10 '>
                  <img src={calender} alt="" className='w-full h-full object-contain rounded-3xl'/>
                </div>
                </div>
                ...
                >
                  ...
                  {/* Content */}
                  <div className='px-10 py-10 flex flex-col gap-2 justify-center items-center h-full relative w-full'>
                  <div className='boldText text-2xl mb-2 text-[#fff]'>Plan Your Perfect Stay</div>

                      <div className='flex gap-5 justify-between items-center py-2 px-5 bg-[#fff] rounded-3xl w-full'>
                        <div className='flex items-center gap-2'>
                          <TbHome2/> <span className='font-semibold'>Room</span> <span className='text-[#535353]'>Pine Log</span>
                        </div>
                        <span className='text-xl'><RiArrowDropDownLine/></span>
                      </div>
                      <div className='flex gap-5 justify-between items-center py-2 px-5 bg-[#fff] rounded-3xl w-full'>
                        <div className='flex items-center gap-2'>
                          <BsCalendar3/> <span className='font-semibold'>Check-in</span> <span className='text-[#535353]'>11 April 2025</span>
                        </div>
                        <span className='text-xl'><RiArrowDropDownLine/></span>
                      </div>
                      <div className='flex gap-5 justify-between items-center py-2 px-5 bg-[#fff] rounded-3xl w-full'>
                        <div className='flex items-center gap-2'>
                          <BsCalendar3/> <span className='font-semibold'>Check-out</span> <span className='text-[#535353]'>12 April 2025</span>
                        </div>
                        <span className='text-xl'><RiArrowDropDownLine/></span>
                      </div>
                      <div className='flex gap-5 justify-between items-center py-2 px-5 bg-[#fff] rounded-3xl w-full'>
                        <div className='flex items-center gap-2'>
                          <HiMiniUsers/> <span className='font-semibold'>Guests</span> <span className='text-[#535353]'>4 Adults</span>
                        </div>
                        <span className='text-xl'><RiArrowDropDownLine/></span>
                      </div>
                  </div>
            ...
            <div className="col-span-2 flex flex-col gap-2">
              ...
              >
                ...
                <div className='w-[250px] mx-auto h-[250px] bg-[#fff] m-auto rounded-full overflow-hidden'>
                  <iframe className='w-full h-full object-cover' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62529.631129750036!2d76.04461557075668!3d11.616081628472966!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba6733459fb33d7%3A0xa5b953217a9fc043!2sKalpetta%2C%20Kerala%2C%20India!5e0!3m2!1sen!2snl!4v1745922003269!5m2!1sen!2snl"  loading="lazy"></iframe>
                </div>
                </div>
              </div>
            </div>
